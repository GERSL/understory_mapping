...
#SBATCH --exclude=cn455,cn448,gpu13,cn453,cn454
...
matlab -nodisplay -nosplash -singleCompThread -r 'autoComputeInputsS2TimeSeries($SLURM_ARRAY_TASK_ID, $SLURM_ARRAY_TASK_MAX)'\;exit\; 
